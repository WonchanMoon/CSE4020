...
def main():
    ...
    arm2 = Node(arm, glm.translate(glm.vec3(.5,0,0)), glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    arm3 = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    arm4 = Node(arm3, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
