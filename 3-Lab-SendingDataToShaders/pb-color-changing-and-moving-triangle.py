...
void main()
{
    gl_Position = vec4(vin_pos.x+u_pos, vin_pos.y, vin_pos.z, 1.0);
...
def main():
    ...
    u_pos_loc = glGetUniformLocation(shader_program, 'u_pos') # find uniform's location
    ...
    while not glfwWindowShouldClose(window):
        ...
        # update uniforms
        t = glfwGetTime()
        alpha = (glm.sin(t) + 1) * .5  # 0~1
        glUniform1f(u_color_loc, alpha)
        beta = (glm.sin(t))    # -1~1
        glUniform1f(u_pos_loc, beta)
